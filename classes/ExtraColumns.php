...
final class ExtraColumns
{

    public function __construct(AC\Entity\Plugin $plugin, AC\Vendor\DI\Container $container)
    {
    }
    ...
    public function add_menu_item(AC\Admin\Menu $menu)
    {
        ...
        $menu->add_item(
            new AC\Admin\Menu\Item(
                ExperimentalColumns::SETTINGS_NAME,
                $url,
                __('Experimental Columns', 'codepress-admin-columns')
            )
        );
    }
